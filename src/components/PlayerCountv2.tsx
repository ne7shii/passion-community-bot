...
const PlayerCount = (props: Props) => {
    ...
    return (
        <div className={`flex min-h-screen flex-col items-center gap-5 px-7 bg-[url('/bg-w-text.png')] bg-contain bg-no-repeat`}>
            ...
            */}
            <div className={`text-[10rem] font-bold bg-gradient-to-r from-red-500 to-blue-500 bg-clip-text mt-80 text-transparent ${!props.count && 'invisible'}`}>
                {props.count || '0'}
            </div>
